...
摘要：web-78 有个include，我们使用filter协议 得到flag.php的base64编码，进行解码得到flag web-79 这题过滤了php，所以我们就不能用php伪协议了，我们用data伪协议 payload 在查看页面源码就得到flag了 web-80-81日志包含 这题php和da。
